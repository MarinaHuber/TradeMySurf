...
struct GuideView: View {
    ...
    let data = [
        ...
        ("What is The history of surf?", "The history of surfing dates back thousands of years and is deeply rooted in the cultures of the Pacific Islands, particularly Hawaii and Polynesia. Surfing was known as 'the sport of kings' in ancient Hawaii. Royalty practiced surfing as a demonstration of their power and divine right to rule. Today, surfing is a global sport and culture. It was included in the Olympics for the first time at the Tokyo 2020 Games"),
