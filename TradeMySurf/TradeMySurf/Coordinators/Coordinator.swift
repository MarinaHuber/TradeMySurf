...
final class Coordinator: UIResponder, CoorinatorPresenting {
    ...
    func presentWelcome() {
        ...
        let navigationWelcome = BaseNavigationController(rootViewController: welcomeController)
    ...
    func presentTabBar() {
        ...
        guard let navigationController = window.rootViewController as? BaseNavigationController else { fatalError() }
